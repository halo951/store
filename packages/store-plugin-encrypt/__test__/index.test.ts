...
import { StoreEncryptPlugin } from '@fdu/store-plugin-encrypt'
import { StoreModuleHashPlugin } from '@fdu/store-plugin-module-hash'
...
describe('plugin.test', () => {
    ...
    class TestModule extends StoreModule<ITestModel> {
